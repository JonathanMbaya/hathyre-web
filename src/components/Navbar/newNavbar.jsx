...
import PopLogin from "../PopLogin/PopLogin.jsx";
            ...
            <div className="nav-high">
                ...
                <div style={{ width: '25%' }} className="icons-users">
                    <button onClick={toggleSearch} style={{ borderRadius: "1rem", display: "flex", alignItems: "center" }}>
                        _<FontAwesomeIcon icon={faMagnifyingGlass} size="1x" />
                    </button>
                    ...
                    <div style={{margin:'.5rem'}}>
                        {!userConnected && (
                            ...
                            <li>
                                <Link className="link-without-decoration">
                ...
                <div className="icons-users">
                    ...
                    <div className={`menu ${isOpen ? 'open' : ''}`}>
                        ...
                        <nav className="mobile">
                            ...
                            <ul>
                                <li><Link to="/" className="link-without-decoration"><FontAwesomeIcon icon={faHouse} /></Link></li>
                                <li><FontAwesomeIcon icon={faSoap} /><Link to="/product" className="link-without-decoration">Savons</Link><FontAwesomeIcon icon={faChevronRight} /></li>
                                <li><FontAwesomeIcon icon={faDroplet} /><Link to="/" className="link-without-decoration">Beurres et Huiles</Link><FontAwesomeIcon icon={faChevronRight} /></li>
                                <li><FontAwesomeIcon icon={faRing} /><Link to="/" className="link-without-decoration">Accessoires</Link><FontAwesomeIcon icon={faChevronRight} /></li>
                                <li><Link to="/apropos" className="link-without-decoration">A propos de Hathyre</Link></li>
                                <li><Link className="link-without-decoration" to="https://instagram.com/hathyre_/" target="_blank" rel="noopener noreferrer">Nous rejoindre sur Instagram</Link></li>
                            </ul>
                            <ul>
                                <li><Link className="link-without-decoration" to="/account">Mon compte</Link></li>
                                <li><Link className="link-without-decoration" to="/faq">FAQ</Link></li>
                            </ul>
                        </nav>
                    </div>
                </div>
