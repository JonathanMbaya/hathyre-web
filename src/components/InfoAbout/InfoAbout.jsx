        ...
        <>
            <div id='block' className='block-tri-info'>
                <div className='tri-info'>
                    ...
                    <p>
                        Chez <strong>Hathyre</strong>, nous célébrons la beauté naturelle grâce à des produits 
                        formulés à partir d'<strong>ingrédients naturels</strong>, comme le <strong>beurre de karité</strong>. Inspirés 
                        par des traditions ancestrales, nos soins pour la peau et le corps sont riches en nutriments, 
                        offrant des solutions naturelles, respectueuses de votre <strong>santé</strong> et de l'<strong>environnement</strong>.
                    </p>
                </div>
                ...
                <div className='tri-info'>
                    ...
                    <p>
                        Le <strong>beurre de karité</strong> est l'ingrédient clé de nos produits. Reconnu pour ses 
                        <strong> propriétés hydratantes</strong>, apaisantes et réparatrices, il aide la peau à rester douce 
                        et éclatante. Chaque produit <strong>Hathyre</strong> est conçu à partir de karité de haute qualité, 
                        issu de sources durables, pour une peau saine tout en soutenant les <strong>communautés locales</strong>.
                    </p>
                </div>
