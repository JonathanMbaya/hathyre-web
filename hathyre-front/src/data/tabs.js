const tabsData1 = [
    {
      buttonContent: "Basique 🥉",
      tabHeading: "Plan basique à 9.99€/m",
    ...
    {
      buttonContent: "Pro 🥈",
      tabHeading: "Plan professionnel à 29.99€/m",
    ...
    {
      buttonContent: "Entreprise 🥇",
      tabHeading: "Plan entreprise - nous contacter",
      txt: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio provident voluptatem ipsam exercitationem doloribus! Totam ab nihil ipsum voluptas aperiam beatae expedita quae facilis ducimus.",
    },
  ]
  const tabsData2 = [
    {
    ...
    {
      buttonContent: "Poisson",
      tabHeading: "Plan entreprise - nous contacter",
      txt: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio provident voluptatem ipsam exercitationem doloribus! Totam ab nihil ipsum voluptas aperiam beatae expedita quae facilis ducimus.",
    },
  ]
  export { tabsData1, tabsData2 }